...
{
    echo ">>> $4 ($3)"
    sudo mysql " -u$1" "-p$2" ramverk1_project < "$3" > /dev/null
    if [ $? -ne 0 ]; then
...
loadSqlIntoDB "root" "pass" "sql/mysql/setup.sql" "Initiate database and user"
loadSqlIntoDB "root" "pass" "sql/mysql/ddl_tables.sql" "Create tables"
...
loadSqlIntoDB "root" "pass" "sql/mysql/insert.sql" "Insert data into tables using csv-files"
