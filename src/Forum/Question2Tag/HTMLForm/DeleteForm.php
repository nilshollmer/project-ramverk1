...
class DeleteForm extends FormModel
{
    ...
    protected function getAllItems() : array
    {
        ...
        $question2Tags = ["-1" => "Select an item..."];
        foreach ($question2Tag->findAll() as $obj) {
            $question2Tags[$obj->id] = "{$obj->column1} ({$obj->id})";
        }

        return $question2Tags;
    }
    ...
    public function callbackSubmit() : bool
    {
        $question2Tag = new Question2Tag();
        $question2Tag->setDb($this->di->get("dbqb"));
        $question2Tag->find("id", $this->form->value("select"));
        $question2Tag->delete();
        return true;
    }
